import{i as E,t as S,A as _,e as I,D as q,a as u,r as d,P as M,B as k,d as B,E as O,h as D,T as R,b as T,s as P,x as v,f as F}from"./index-BiQKaKqB.js";import{i as H,f as V,a as L,D as z,F as $}from"./input-field-container-styles-wCIB69et.js";import"./vaadin-list-box-nOLHcvHx.js";import{o as U,O as j,p as W}from"./templates-CS5a4Wik.js";const g={};class K extends E{constructor(e){if(super(e),this.previousValue=g,e.type!==S.ELEMENT)throw new Error("renderer only supports binding to element")}render(e,t){return _}update(e,[t,i]){var n;const s=this.previousValue===g;if(!this.hasChanged(i))return _;this.previousValue=Array.isArray(i)?Array.from(i):i;const a=e.element;if(s){const r=(n=e.options)===null||n===void 0?void 0:n.host;this.addRenderer(a,t,{host:r})}else this.runRenderer(a);return _}hasChanged(e){let t=!0;return Array.isArray(e)?Array.isArray(this.previousValue)&&this.previousValue.length===e.length&&e.every((i,n)=>i===this.previousValue[n])&&(t=!1):this.previousValue===e&&(t=!1),t}}class Q extends K{addRenderer(e,t,i){e.renderer=(n,s)=>{q(t.call(i.host,s),n,i)}}runRenderer(e){e.requestContentUpdate()}}const Y=I(Q),G=(o,e)=>Y(o,e);/**
 * @license
...
`,w=[U,A,Z];d("",w,{moduleId:"lumo-menu-overlay"});/**
 * @license
 * Copyright (c) 2000 - 2023 Vaadin Ltd.
 *
 * This program is available under Vaadin Commercial License and Service Terms.
 ...
 */d("vaadin-select-overlay",u`
  ...
  `,{moduleId:"vaadin-select-overlay-styles"});class b extends N(j){static get is(){return"vaadin-select-overlay"}requestContentUpdate(){if(super.requestContentUpdate(),this.owner){const e=this._getMenuElement();this.owner._assignMenuElement(e)}}_getMenuElement(){return Array.from(this.children).find(e=>e.localName!=="style")}}customElements.define(b.is,b);/**
 * @license
 * Copyright (c) 2000 - 2023 Vaadin Ltd.
 *
 * This program is available under Vaadin Commercial License and Service Terms.
