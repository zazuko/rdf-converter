import{r as n,a as s,d as v,c as b,g as f,E as g,T as c,b as d,h,F as x,j as k,k as _,s as u,p as y,x as a}from"./index-BiQKaKqB.js";import{L as C,D as w,C as T,r as E,h as F,F as P}from"./input-field-container-styles-wCIB69et.js";import{D as S,I as $,a as z,L as A}from"./vaadin-text-field-CB5taJP-.js";import"./vaadin-list-box-nOLHcvHx.js";n("vaadin-checkbox",s`
    :host {
 ...
 * See https://vaadin.com/commercial-license-and-service-terms for the full
 * license.
 */class l extends C(N(w(f(g(c(T(d))))))){static get is(){return"vaadin-checkbox"}static get template(){return h`
      <style>
        :host {
          display: inline-block;
        }
 ...
 * See https://vaadin.com/commercial-license-and-service-terms for the full
 * license.
 */class p extends P(x(b(k(c(d))))){static get is(){return"vaadin-checkbox-group"}static get template(){return h`
      <style>
        :host {
          display: inline-flex;
        }
