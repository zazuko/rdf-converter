import{a as m,r as h,T as _,j as v,b,h as f,k as y,G as g,H as w,J as x}from"./index-BiQKaKqB.js";/**
 * @license
 ...
 * See https://vaadin.com/commercial-license-and-service-terms for the full
 * license.
 */class C{static getTabbableNodes(e){const t=[];return this._collectTabbableNodes(e,t)?this._sortByTabIndex(t):t}static isFocusable(e){return e.matches("input, select, textarea, button, object")?e.matches(":not([disabled])"):e.matches("a[href], area[href], iframe, [tabindex], [contentEditable]")}static isTabbable(e){return this.isFocusable(e)&&e.matches(':not([tabindex="-1"])')&&this._isVisible(e)}static _normalizedTabIndex(e){if(this.isFocusable(e)){const t=e.getAttribute("tabindex")||0;return Number(t)}return-1}static _collectTabbableNodes(e,t){if(e.nodeType!==Node.ELEMENT_NODE||!this._isVisible(e))return!1;const o=e,i=this._normalizedTabIndex(o);let n=i>0;i>=0&&t.push(o);let s;if(o.localName==="slot"?s=o.assignedNodes({flatten:!0}):s=(o.shadowRoot||o).children,s)for(let a=0;a<s.length;a++)n=this._collectTabbableNodes(s[a],t)||n;return n}static _isVisible(e){let t=e.style;return t.visibility!=="hidden"&&t.display!=="none"?(t=window.getComputedStyle(e),t.visibility!=="hidden"&&t.display!=="none"):!1}static _sortByTabIndex(e){const t=e.length;if(t<2)return e;const o=Math.ceil(t/2),i=this._sortByTabIndex(e.slice(0,o)),n=this._sortByTabIndex(e.slice(o));return this._mergeSortByTabIndex(i,n)}static _mergeSortByTabIndex(e,t){const o=[];for(;e.length>0&&t.length>0;)this._hasLowerTabOrder(e[0],t[0])?o.push(t.shift()):o.push(e.shift());return o.concat(e,t)}static _hasLowerTabOrder(e,t){const o=Math.max(e.tabIndex,0),i=Math.max(t.tabIndex,0);return o===0||i===0?i>o:o>i}}/**
 * @license
 * Copyright (c) 2000 - 2023 Vaadin Ltd.
 *
 * This program is available under Vaadin Commercial License and Service Terms.
